...
function (_React$Component) {
  ...
  _proto.renderRow = function renderRow(props, cells, shouldRenderExpandedRow, rowData) {
    ...
    if (shouldFixedColumn && contentWidth > width) {
      ...
      return React.createElement(_Row["default"], (0, _extends2["default"])({}, restRowProps, {
        "data-depth": depth,
        style: rowStyles
      ...
      }, (0, _utils.mergeCells)((0, _utils.resetLeftForCells)(fixedLeftCells))) : null, React.createElement(_CellGroup["default"], null, (0, _utils.mergeCells)(scrollCells)), fixedRightCellGroupWidth ? React.createElement(_CellGroup["default"], {
        fixed: "right",
        style: this.isRTL() ? {
